...
#inputs  1 output name, 2 PF file name, 3 MLWDF file name, 4 EXP/PF file name, 5 Title, 6 x label, 7 Y label ,8 my algo ,9 my algo2 
filename=.temp3.data
...
# echo "set xtics ($labelxtic)" >> $filename
 ...
 echo "plot  '$2' using 2:xtic(1) title 'PF', '$3' using 2:xtic(1) title 'MLWDF', '$4' using 2:xtic(1) title 'EXP/PF','$8' using 2:xtic(1) title 'my_algo','$9' using 2:xtic(1) title 'my_algo'" >>$filename
gnuplot $filename
rm -Rf $filename
