...
until [ $NBUE -gt $MAXUSERS ]; do
	...
	../../LTE-Sim SingleCellWithI $CELS $RADIUS $NBUE $NBVOIP $NBVIDEO $NBBE $NBCBR 7 $FRAME_STRUCT $SPEED $MAXDELAY $VIDEOBITRATE $COUNT > $TOTALNAME
	    echo ../../LTE-Sim SingleCellWithI $CELS $RADIUS $NBUE $NBVOIP $NBVIDEO $NBBE $NBCBR 7 $FRAME_STRUCT $SPEED $MAXDELAY $VIDEOBITRATE $COUNT
   	    echo FILE $TOTALNAME CREATED!
 	let COUNT=COUNT+1
	done
	COUNT=1
	...
	../../LTE-Sim SingleCellWithI $CELS $RADIUS $NBUE $NBVOIP $NBVIDEO $NBBE $NBCBR 8 $FRAME_STRUCT $SPEED $MAXDELAY $VIDEOBITRATE $COUNT > $TOTALNAME
	    echo ../../LTE-Sim SingleCellWithI $CELS $RADIUS $NBUE $NBVOIP $NBVIDEO $NBBE $NBCBR 8 $FRAME_STRUCT $SPEED $MAXDELAY $VIDEOBITRATE $COUNT
   	    echo FILE $TOTALNAME CREATED!
 	let COUNT=COUNT+1
	done
	COUNT=1
