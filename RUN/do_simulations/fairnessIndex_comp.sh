...
until [ $NBUE -gt $2 ]; do
	...
	../../TOOLS/./make_fairness_index  tmp_2 >> temporal
	rm tmp
	rm tmp_2
	 let COUNT=COUNT+1
	done
	...
	grep "FI" temporal  | awk '{print $2}'  > temporal2
	./compute_average.sh temporal2 | awk '{print "'$NBUE' "$1}' >> MY_algo_Y1_$8_$7.dat
	COUNT=1
	rm temporal
	rm temporal2
	...
	grep "FI" temporal  | awk '{print $2}'  > temporal2
	./compute_average.sh temporal2 | awk '{print "'$NBUE' "$1}' >> MY_algo2_Y1_$8_$7.dat
	COUNT=1
	rm temporal
	rm temporal2
...
./Graph1.sh $7_$8 PF_Y1_$8_$7.dat MLWDF_Y1_$8_$7.dat EXPPF_Y1_$8_$7.dat $7-Fairness-Index Users Fairness_Index MY_algo_Y1_$8_$7.dat MY_algo2_Y1_$8_$7.dat
