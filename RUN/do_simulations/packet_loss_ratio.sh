...
until [ $NBUE -gt $2 ]; do
	...
	./compute_average.sh temporal | awk '{print "'$NBUE' "$1}' >> MY_algo_Y1_$8_$7.dat 
	COUNT=1
	rm temporal
	 
     #GRAPHIC FOR MY ALGORITHM2
	until [ $COUNT -gt $NUMSIM ]; do
	...
	./compute_average.sh temporal | awk '{print "'$NBUE' "$1}' >> MY_algo2_Y1_$8_$7.dat 
	COUNT=1
	rm temporal
...
./Graph1.sh $7_$8 PF_Y1_$8_$7.dat MLWDF_Y1_$8_$7.dat EXPPF_Y1_$8_$7.dat  $7-Packet-Loss-Ratio Users PLR MY_algo_Y1_$8_$7.dat MY_algo2_Y1_$8_$7.dat
