...
#include "../protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler.h"
#include "../protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.h"
  ...
  switch (type)
    {
      ...
      case ENodeB::DLScheduler_LOG_RULE:
      	...
      	mac->SetDownlinkPacketScheduler (scheduler);
		  break;
      case ENodeB::DLScheduler_My_Algo:                        //My ALGO
      	scheduler = new  DL_my_algo_PacketScheduler ();
      	scheduler->SetMacEntity (mac);
      	mac->SetDownlinkPacketScheduler (scheduler);
		  break;
      case ENodeB::DLScheduler_My_Algo2:                       //My ALGO2
      	scheduler = new  DL_my_algo_PacketScheduler2 ();
      	scheduler->SetMacEntity (mac);
      	mac->SetDownlinkPacketScheduler (scheduler);
		  break;
